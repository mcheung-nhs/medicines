$(document).ready(function () {
  ...
  function scrolledSection(start, section) {
    ...
    if (start) {
      ...
      if (!debugMode) {
        ...
        console.log(section + ' (Time: ' + timeToScroll + 's)');
      }
      ...
      if (!debugMode) {
        ...
        console.log('User reached the "' + section + '" section (Time: ' + timeToScroll + 's)');
      }

      $('.c-back-to-top').on('click', function () {
  ...
  function trackLocation() {
    ...
    $('h2, h3').not('.above, .util-visuallyhidden').each(function () {
      if (aboveFold(bottom, $(this))) {
        $(this).addClass('above');
        scrolledSection(false, $(this).text());
      }
    });
